	...
	public static void main(String[] args) {
        ...
        try {
        	...
        	while (true) {
	            ...
	            byte[] outData3 = processor.convertToByteArray(totalConsonants);
	            int totalPunctuations = processor.countPunctuation();
	            byte[] outData4 = processor.convertToByteArray(totalPunctuations);
